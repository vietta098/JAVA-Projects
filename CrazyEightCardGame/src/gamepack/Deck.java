...
public class Deck {
     ...
     */
    public void dealCard(int dealAmnt, Hand handToDeal) {
         ...
         * 			Student part								   =
         * 														   =
         * 		deal card by number for players					   =
         * 														   =
         * 														   =
         * */
        
        int size = deck.length - cardsUsed;
        for(int i = 0; i < dealAmnt; i++) {
        	this.shuffle();
        	handToDeal.addCard(deck[i]);
        	cardsUsed++;
        }
    }
